...
import cn.secretinstitute.secretseasons.Datagen.DataGenEvent;
import cn.secretinstitute.secretseasons.Datagen.ModBlockStateProvider;
...
@Mod(Utils.MOD_ID)
public class SecretSeasons {

    private static final Logger LOGGER = LogUtils.getLogger();

    public SecretSeasons() {
       ...
       ModBlocks.BLOCKS.register(modEventBus);
        ...
        MainTab.CREATIVE_MODE_TABS.register(modEventBus);
